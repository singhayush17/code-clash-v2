...
LESSONS = [
    ...
    Lesson("expressions", 9, "Expressions", ["AS", "CASE", "calculation"], ["order_items", "products", "employees"], [
    ...
    Lesson("aggregates", 10, "Aggregates", ["COUNT", "SUM", "AVG"], ["products", "orders", "order_items"], [
    ...
    Lesson("grouping", 11, "GROUP BY and HAVING", ["GROUP BY", "HAVING"], ["products", "orders", "order_items", "customers"], [
    ...
    Lesson("insert", 13, "INSERT Rows", ["INSERT"], ["products", "customers", "orders", "order_items"], [
    ...
    Lesson("update", 14, "UPDATE Rows", ["UPDATE", "SET"], ["products", "orders", "support_tickets"], [
    ...
    Lesson("delete", 15, "DELETE Rows", ["DELETE"], ["products", "orders", "support_tickets"], [
        Task("l15-t1", "Delete discontinued products with zero stock.", "", "DELETE FROM products WHERE discontinued = 1 AND stock = 0;", "SELECT id, name FROM products ORDER BY id;"),
    ...
    Lesson("create-table", 16, "CREATE TABLE", ["CREATE TABLE", "types"], ["products"], [
    ...
    Lesson("alter-table", 17, "ALTER TABLE", ["ALTER TABLE"], ["products", "customers"], [
    ...
    Lesson("drop-table", 18, "DROP TABLE", ["DROP TABLE", "IF EXISTS"], ["support_tickets", "shipments"], [
...
LESSONS.extend(
    [
        Lesson("interview-filters", 20, "Interview Filtering Patterns", ["BETWEEN", "NOT IN", "multi-condition"], ["products", "customers", "orders"], [
        ...
        Lesson("date-analytics", 22, "Date Analytics", ["strftime", "julianday", "cohorts"], ["customers", "orders", "shipments"], [
        ...
        Lesson("window-ranking", 24, "Window Ranking", ["ROW_NUMBER", "RANK", "PARTITION BY"], ["products", "customers", "orders", "order_items"], [
        ...
        Lesson("window-analytics", 25, "Running Totals and Moving Averages", ["SUM OVER", "AVG OVER"], ["orders", "order_items", "products"], [
        ...
        Lesson("top-n-per-group", 26, "Top N Per Group", ["ROW_NUMBER", "filter ranked rows"], ["products", "orders", "order_items"], [
        ...
        Lesson("recursive-ctes", 28, "Recursive CTEs", ["WITH RECURSIVE", "hierarchies"], ["employees", "customers"], [
        ...
        Lesson("leetcode-patterns", 32, "Classic Interview Patterns", ["second highest", "duplicates", "gaps"], ["products", "customers", "orders"], [
        ...
        Lesson("data-cleaning", 33, "Data Cleaning Queries", ["TRIM", "COALESCE", "CASE"], ["customers", "products", "shipments"], [
