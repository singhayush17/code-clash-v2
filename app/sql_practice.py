...
LESSONS = [
    ...
    Lesson("ctes", 32, "Common Table Expressions", ["WITH", "readability"], ["customers", "orders", "order_items", "products"], [
    ...
    Lesson("top-n-per-group", 36, "Top N Per Group", ["ROW_NUMBER", "filter ranked rows"], ["products", "orders", "order_items"], [
    ...
    Lesson("advanced-capstone", 37, "Advanced Queries: Interview Capstone", ["Hint-Free", "CTEs", "Windows"], ["customers", "orders", "products"], [
    ...
    Lesson("execution-order", 38, "Query Order", ["WHERE", "GROUP BY", "HAVING", "ORDER BY"], ["orders", "order_items", "customers"], [
    ...
    Lesson("indexes-query-plans", 39, "Indexes and Query Plans", ["CREATE INDEX", "EXPLAIN QUERY PLAN"], ["products", "orders", "customers", "order_items"], [
    ...
    Lesson("interview-filters", 40, "Interview Filtering Patterns", ["BETWEEN", "NOT IN", "multi-condition"], ["products", "customers", "orders"], [
    ...
    Lesson("insert", 41, "INSERT Rows", ["INSERT"], ["products", "customers", "orders", "order_items"], [
    ...
    Lesson("update", 42, "UPDATE Rows", ["UPDATE", "SET"], ["products", "orders", "support_tickets"], [
    ...
    Lesson("delete", 43, "DELETE Rows", ["DELETE"], ["products", "orders", "support_tickets"], [
    ...
    Lesson("create-table", 44, "CREATE TABLE", ["CREATE TABLE", "types"], ["products"], [
    ...
    Lesson("alter-table", 45, "ALTER TABLE", ["ALTER TABLE"], ["products", "customers"], [
    ...
    Lesson("drop-table", 46, "DROP TABLE", ["DROP TABLE", "IF EXISTS"], ["support_tickets", "shipments"], [
    ...
    Lesson("insert-select", 47, "CREATE AS & INSERT SELECT", ["CREATE TABLE AS", "INSERT INTO SELECT"], ["orders", "products"], [
    ...
    Lesson("constraints-not-null-default", 48, "Constraints: NOT NULL & DEFAULT", ["NOT NULL", "DEFAULT", "CREATE TABLE"], [], [
    ...
    Lesson("constraints-unique-check", 49, "Constraints: UNIQUE & CHECK", ["UNIQUE", "CHECK"], [], [
    ...
    Lesson("constraints-keys", 50, "Constraints: Keys", ["PRIMARY KEY", "FOREIGN KEY", "AUTOINCREMENT"], ["customers"], [
    ...
    Lesson("foreign-keys", 51, "Foreign Keys", ["FOREIGN KEY", "ON DELETE", "CASCADE", "RESTRICT", "SET NULL"], ["customers", "orders", "products", "order_items", "shipments", "employees", "support_tickets"], [
    ...
    Lesson("views", 52, "Database Views", ["CREATE VIEW", "DROP VIEW"], ["orders", "order_items", "products"], [
    ...
    Lesson("indexes", 53, "Indexes", ["CREATE INDEX", "UNIQUE INDEX", "DROP INDEX"], ["customers", "orders"], [
    ...
    Lesson("injection", 54, "Security: SQL Injection", ["hacker mode", "authentication bypass", "UNION payloads"], ["customers"], [
    ...
    Lesson("ddl-capstone", 55, "DDL & Admin: Interview Capstone", ["Hint-Free", "Data Modeling"], ["customers", "orders", "products"], [
    ...
    Lesson("leetcode-patterns", 56, "Classic Interview Patterns", ["second highest", "duplicates", "gaps"], ["products", "customers", "orders"], [
    ...
    Lesson("business-analytics", 57, "Business Intelligence SQL", ["JOIN", "arithmetic", "business-logic"], ["customers", "orders", "order_items", "products", "shipments"], [
    ...
    Lesson("final-interview-sets", 58, "Final Interview Sets", ["multi-step", "analytics", "business SQL"], ["customers", "orders", "order_items", "products", "shipments", "support_tickets"], [
    ...
    Lesson("mixed-bag-capstone", 59, "Mixed Bag: Ultimate Capstone", ["Hint-Free", "Advanced Business Logic",
    ...
    ], ["customers", "orders", "order_items", "products", "shipments", "employees", "support_tickets"], [
