...
LESSONS = [
    ...
    Lesson("dates-advanced", 17, "Advanced Dates", ["strftime", "date modifiers"], ["orders", "shipments"], [
    ...
    Lesson("data-types", 18, "Data Types & Casting", ["CAST", "TYPEOF"], ["order_items", "products"], [
    ...
    Lesson("data-cleaning", 19, "Data Cleaning Queries", ["TRIM", "COALESCE", "CASE"], ["customers", "products", "shipments"], [
    ...
    Lesson("aggregates", 20, "Aggregates", ["COUNT", "SUM", "AVG"], ["products", "orders", "order_items"], [
    ...
    Lesson("grouping", 21, "GROUP BY and HAVING", ["GROUP BY", "HAVING"], ["products", "orders", "order_items", "customers"], [
    ...
    Lesson("conditional-aggregation", 22, "Conditional Aggregation", ["SUM(CASE)", "COUNT(CASE)"], ["orders", "order_items", "customers", "products"], [
    ...
    Lesson("union-intersect-except", 23, "UNION / INTERSECT / EXCEPT", ["UNION", "UNION ALL", "INTERSECT", "EXCEPT"], ["customers", "orders", "products", "order_items", "shipments"], [
    ...
    Lesson("set-operations-advanced", 24, "Set Operations", ["UNION", "INTERSECT", "EXCEPT"], ["customers", "orders", "products", "order_items"], [
    ...
    Lesson("advanced-review", 25, "Subqueries and Sets", ["subquery", "UNION", "EXCEPT"], ["products", "customers", "orders", "order_items"], [
    ...
    Lesson("ctes", 26, "Common Table Expressions", ["WITH", "readability"], ["customers", "orders", "order_items", "products"], [
    ...
    Lesson("recursive-ctes", 27, "Recursive CTEs", ["WITH RECURSIVE", "hierarchies"], ["employees", "customers"], [
    ...
    Lesson("window-ranking", 28, "Window Ranking", ["ROW_NUMBER", "RANK", "PARTITION BY"], ["products", "customers", "orders", "order_items"], [
    ...
    Lesson("window-analytics", 29, "Running Totals and Moving Averages", ["SUM OVER", "AVG OVER"], ["orders", "order_items", "products"], [
    ...
    Lesson("top-n-per-group", 30, "Top N Per Group", ["ROW_NUMBER", "filter ranked rows"], ["products", "orders", "order_items"], [
    ...
    Lesson("execution-order", 31, "Query Order", ["WHERE", "GROUP BY", "HAVING", "ORDER BY"], ["orders", "order_items", "customers"], [
    ...
    Lesson("indexes-query-plans", 32, "Indexes and Query Plans", ["CREATE INDEX", "EXPLAIN QUERY PLAN"], ["products", "orders", "customers", "order_items"], [
    ...
    Lesson("interview-filters", 33, "Interview Filtering Patterns", ["BETWEEN", "NOT IN", "multi-condition"], ["products", "customers", "orders"], [
    ...
    Lesson("insert", 34, "INSERT Rows", ["INSERT"], ["products", "customers", "orders", "order_items"], [
    ...
    Lesson("update", 35, "UPDATE Rows", ["UPDATE", "SET"], ["products", "orders", "support_tickets"], [
    ...
    Lesson("delete", 36, "DELETE Rows", ["DELETE"], ["products", "orders", "support_tickets"], [
    ...
    Lesson("create-table", 37, "CREATE TABLE", ["CREATE TABLE", "types"], ["products"], [
    ...
    Lesson("alter-table", 38, "ALTER TABLE", ["ALTER TABLE"], ["products", "customers"], [
    ...
    Lesson("drop-table", 39, "DROP TABLE", ["DROP TABLE", "IF EXISTS"], ["support_tickets", "shipments"], [
    ...
    Lesson("insert-select", 40, "CREATE AS & INSERT SELECT", ["CREATE TABLE AS", "INSERT INTO SELECT"], ["orders", "products"], [
    ...
    Lesson("constraints-not-null-default", 41, "Constraints: NOT NULL & DEFAULT", ["NOT NULL", "DEFAULT", "CREATE TABLE"], [], [
    ...
    Lesson("constraints-unique-check", 42, "Constraints: UNIQUE & CHECK", ["UNIQUE", "CHECK"], [], [
    ...
    Lesson("constraints-keys", 43, "Constraints: Keys", ["PRIMARY KEY", "FOREIGN KEY", "AUTOINCREMENT"], ["customers"], [
    ...
    Lesson("views", 44, "Database Views", ["CREATE VIEW", "DROP VIEW"], ["orders", "order_items", "products"], [
    ...
    Lesson("indexes", 45, "Indexes", ["CREATE INDEX", "UNIQUE INDEX", "DROP INDEX"], ["customers", "orders"], [
    ...
    Lesson("injection", 46, "Security: SQL Injection", ["hacker mode", "authentication bypass", "UNION payloads"], ["customers"], [
    ...
    Lesson("leetcode-patterns", 47, "Classic Interview Patterns", ["second highest", "duplicates", "gaps"], ["products", "customers", "orders"], [
    ...
    Lesson("business-analytics", 48, "Business Intelligence SQL", ["JOIN", "arithmetic", "business-logic"], ["customers", "orders", "order_items", "products", "shipments"], [
    ...
    Lesson("final-interview-sets", 49, "Final Interview Sets", ["multi-step", "analytics", "business SQL"], ["customers", "orders", "order_items", "products", "shipments", "support_tickets"], [
