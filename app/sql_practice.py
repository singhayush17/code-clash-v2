...
LESSONS = [
    ...
    Lesson("joins-capstone", 13, "Joins: Interview Capstone", ["Hint-Free", "Data Modeling"], ["customers", "orders", "order_items", "products", "shipments", "employees", "support_tickets"], [
    ...
    Lesson("nulls", 14, "Working with NULL", ["IS NULL", "COALESCE"], ["customers", "employees", "shipments"], [
    ...
    Lesson("expressions", 15, "Expressions", ["AS", "CASE", "calculation"], ["order_items", "products", "employees"], [
    ...
    Lesson("string-functions", 16, "String Functions", ["LOWER", "SUBSTR", "LENGTH"], ["customers", "products"], [
    ...
    Lesson("date-analytics", 17, "Date Analytics", ["strftime", "julianday", "cohorts"], ["customers", "orders", "shipments"], [
    ...
    Lesson("dates-advanced", 18, "Advanced Dates", ["strftime", "date modifiers"], ["orders", "shipments"], [
    ...
    Lesson("data-types", 19, "Data Types & Casting", ["CAST", "TYPEOF"], ["order_items", "products"], [
    ...
    Lesson("data-cleaning", 20, "Data Cleaning Queries", ["TRIM", "COALESCE", "CASE"], ["customers", "products", "shipments"], [
    ...
    Lesson("aggregates", 21, "Aggregates", ["COUNT", "SUM", "AVG"], ["products", "orders", "order_items"], [
    ...
    Lesson("grouping", 22, "GROUP BY and HAVING", ["GROUP BY", "HAVING"], ["products", "orders", "order_items", "customers"], [
    ...
    Lesson("aggregations-capstone", 24, "Aggregations: Interview Capstone", ["Hint-Free", "Data Analytics"], ["customers", "orders", "order_items", "products", "shipments", "employees", "support_tickets"], [
    ...
    Lesson("union-intersect-except", 25, "UNION / INTERSECT / EXCEPT", ["UNION", "UNION ALL", "INTERSECT", "EXCEPT"], ["customers", "orders", "products", "order_items", "shipments"], [
    ...
    Lesson("set-operations-advanced", 26, "Set Operations", ["UNION", "INTERSECT", "EXCEPT"], ["customers", "orders", "products", "order_items"], [
    ...
    Lesson("advanced-review", 27, "Subqueries and Sets", ["subquery", "UNION", "EXCEPT"], ["products", "customers", "orders", "order_items"], [
    ...
    Lesson("ctes", 28, "Common Table Expressions", ["WITH", "readability"], ["customers", "orders", "order_items", "products"], [
    ...
    Lesson("recursive-ctes", 29, "Recursive CTEs", ["WITH RECURSIVE", "hierarchies"], ["employees", "customers"], [
    ...
    Lesson("window-ranking", 30, "Window Ranking", ["ROW_NUMBER", "RANK", "PARTITION BY"], ["products", "customers", "orders", "order_items"], [
    ...
    Lesson("window-analytics", 31, "Running Totals and Moving Averages", ["SUM OVER", "AVG OVER"], ["orders", "order_items", "products"], [
    ...
    Lesson("top-n-per-group", 32, "Top N Per Group", ["ROW_NUMBER", "filter ranked rows"], ["products", "orders", "order_items"], [
    ...
    Lesson("execution-order", 33, "Query Order", ["WHERE", "GROUP BY", "HAVING", "ORDER BY"], ["orders", "order_items", "customers"], [
    ...
    Lesson("indexes-query-plans", 34, "Indexes and Query Plans", ["CREATE INDEX", "EXPLAIN QUERY PLAN"], ["products", "orders", "customers", "order_items"], [
    ...
    Lesson("interview-filters", 35, "Interview Filtering Patterns", ["BETWEEN", "NOT IN", "multi-condition"], ["products", "customers", "orders"], [
    ...
    Lesson("insert", 36, "INSERT Rows", ["INSERT"], ["products", "customers", "orders", "order_items"], [
    ...
    Lesson("update", 37, "UPDATE Rows", ["UPDATE", "SET"], ["products", "orders", "support_tickets"], [
    ...
    Lesson("delete", 38, "DELETE Rows", ["DELETE"], ["products", "orders", "support_tickets"], [
    ...
    Lesson("create-table", 39, "CREATE TABLE", ["CREATE TABLE", "types"], ["products"], [
    ...
    Lesson("alter-table", 40, "ALTER TABLE", ["ALTER TABLE"], ["products", "customers"], [
    ...
    Lesson("drop-table", 41, "DROP TABLE", ["DROP TABLE", "IF EXISTS"], ["support_tickets", "shipments"], [
    ...
    Lesson("insert-select", 42, "CREATE AS & INSERT SELECT", ["CREATE TABLE AS", "INSERT INTO SELECT"], ["orders", "products"], [
    ...
    Lesson("constraints-not-null-default", 43, "Constraints: NOT NULL & DEFAULT", ["NOT NULL", "DEFAULT", "CREATE TABLE"], [], [
    ...
    Lesson("constraints-unique-check", 44, "Constraints: UNIQUE & CHECK", ["UNIQUE", "CHECK"], [], [
    ...
    Lesson("constraints-keys", 45, "Constraints: Keys", ["PRIMARY KEY", "FOREIGN KEY", "AUTOINCREMENT"], ["customers"], [
    ...
    Lesson("views", 46, "Database Views", ["CREATE VIEW", "DROP VIEW"], ["orders", "order_items", "products"], [
    ...
    Lesson("indexes", 47, "Indexes", ["CREATE INDEX", "UNIQUE INDEX", "DROP INDEX"], ["customers", "orders"], [
    ...
    Lesson("injection", 48, "Security: SQL Injection", ["hacker mode", "authentication bypass", "UNION payloads"], ["customers"], [
    ...
    Lesson("leetcode-patterns", 49, "Classic Interview Patterns", ["second highest", "duplicates", "gaps"], ["products", "customers", "orders"], [
    ...
    Lesson("business-analytics", 50, "Business Intelligence SQL", ["JOIN", "arithmetic", "business-logic"], ["customers", "orders", "order_items", "products", "shipments"], [
    ...
    Lesson("final-interview-sets", 51, "Final Interview Sets", ["multi-step", "analytics", "business SQL"], ["customers", "orders", "order_items", "products", "shipments", "support_tickets"], [
