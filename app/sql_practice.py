...
LESSONS = [
    ...
    Lesson("views", 51, "Database Views", ["CREATE VIEW", "DROP VIEW"], ["orders", "order_items", "products"], [
    ...
    Lesson("indexes", 52, "Indexes", ["CREATE INDEX", "UNIQUE INDEX", "DROP INDEX"], ["customers", "orders"], [
    ...
    Lesson("injection", 53, "Security: SQL Injection", ["hacker mode", "authentication bypass", "UNION payloads"], ["customers"], [
    ...
    Lesson("ddl-capstone", 54, "DDL & Admin: Interview Capstone", ["Hint-Free", "Data Modeling"], ["customers", "orders", "products"], [
    ...
    Lesson("leetcode-patterns", 55, "Classic Interview Patterns", ["second highest", "duplicates", "gaps"], ["products", "customers", "orders"], [
    ...
    Lesson("business-analytics", 56, "Business Intelligence SQL", ["JOIN", "arithmetic", "business-logic"], ["customers", "orders", "order_items", "products", "shipments"], [
    ...
    Lesson("final-interview-sets", 57, "Final Interview Sets", ["multi-step", "analytics", "business SQL"], ["customers", "orders", "order_items", "products", "shipments", "support_tickets"], [
    ...
    Lesson("mixed-bag-capstone", 58, "Mixed Bag: Ultimate Capstone", ["Hint-Free", "Advanced Business Logic",
